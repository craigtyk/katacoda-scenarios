Getting started with Tyk couldn't be easier than with Docker compose. This step will show you how to clone the Tyk Gateway Docker repository and get you ready to deploy Tyk and Redis.
